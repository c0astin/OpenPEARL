...
public class NodeUtils {
    ...
    public static Node getChildByName(Node node, String name) {
        // System.out.println("getChildByName of node "+ node.getNodeName()+" "
        // +node.getAttributes().getNamedItem("name")+ " looking for "+name);
    ...
    /**
     * get the number of ELEMENT_NODEs of the given node Text-nodes are skipped
     * 
     * @param node
    ...
    /**
     * get an attribut value \return null, if the attribute is not set
     * 
     */
