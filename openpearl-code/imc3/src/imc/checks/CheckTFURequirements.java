    ...
    public CheckTFURequirements(List<Module> modules) {
        ...
        for (Module m : modules) {
            ...
            for (int i = 0; i < userDationTfuInformations.size(); i++) {
                ...
                if (sysname == null)
                    continue; // nothing to do for configurations
                ...
                if (tfuInSystemEntry != null) {
                    ...
                    if (sMaxTfu != null) {
                        ...
                        Log.setLocation(m.getSourceFileName(), userDationTfuInfo.getLine(),
                                userDationTfuInfo.getCol());
                        if (udTfuSize == -1) {
                            ...
                            Log.error("userdation '" + userDationTfuInfo.getUserName()
                            + "' requires a TFU record of " + udTfuSize + "' -- system dation '"
                            + platformName + "' provides max " + maxTfu);
                        }
