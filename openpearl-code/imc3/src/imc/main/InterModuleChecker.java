 ...
 * <ol>
 * <li>read platform definition and module interface definition xml-files and create individual DOM
 * trees
...
public class InterModuleChecker {
    ...
    static boolean useNameSpace = true;         // default for OpenPEARL
    static boolean allowMultipleSystemparts = true; // default for OpenPEARL
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < inputFiles.size(); i++) {
            Module mXml = new Module(inputFiles.get(i) + ".xml", verbose,useNameSpace);
            modules.add(mXml);
        }
    ...
    private static boolean checkAndProcessArguments(String[] args) {
        ...
        while (i < args.length) {
            ...
            if (arg.equals("--help")) {
                ...
                useNameSpace = true;
                allowMultipleSystemparts=true;
            } else if (arg.equals("-std=PEARL90")) {
                useNameSpace = false;
                allowMultipleSystemparts=false;
    ...
    private static void printHelp() {
        ...
        System.err.println("java InterModuleChecker                           \n"
                + " Options:                                                     \n"
                + "  --help                      Print this help message         \n"
                + "  --verbose                   Print lot of information        \n"
                + "  -b <target>                 Disable semantic checker        \n"
                + "  -o <output>                 output file (default: system.cc)\n"
                + "  -std=PEARL90                no special namespace and one system part allowed\n"
                + "  -std=OpenPEARL              (default) module name defines namespace; multiple system parts allowed"
