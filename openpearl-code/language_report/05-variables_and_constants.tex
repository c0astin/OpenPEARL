...
% reverted to 'from constant' see ticket 353
...
In case of selecting a segment which is not part of the bit string, the
...
In case of selecting a segment which is not part of the \code{CHAR} variable the 
...
%%%%% begin added 2022-01-22 (rm)
The meaning of the \code{ConstantFIXEDExpression} at the \code{FIT} operator
...
the assignment rules must be fullfilled at each usage. An explicit \code{FIT} 
is not required.
%%%%% end added
