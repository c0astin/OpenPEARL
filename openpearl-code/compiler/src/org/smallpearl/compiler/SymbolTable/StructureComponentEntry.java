...
public class StructureComponentEntry extends SymbolTableEntry {
    ...
    public StructureComponentEntry(String name, TypeDefinition type, Boolean hasAssigmentProtection, SmallPearlParser.VariableDenotationContext ctx, Initializer initializer)
    {
        super(name);
        this.m_ctx = ctx;
        this.m_type = type;
